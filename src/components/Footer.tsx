const columns = [
    { header: "Arm", body1: "Lorem ipsum Lorem ipsum", body2: "Lorem ipsum Lorem ipsum", body3: "Lorem ipsum Lorem ipsum", body4: "Lorem ipsum Lorem ipsum" },
    { header: "Palm", body1: "Lorem ipsum Lorem ipsum", body2: "Lorem ipsum Lorem ipsum", body3: "Lorem ipsum Lorem ipsum", body4: "Lorem ipsum Lorem ipsum" },
    { header: "Finger", body1: "Lorem ipsum Lorem ipsum", body2: "Lorem ipsum Lorem ipsum", body3: "Lorem ipsum Lorem ipsum", body4: "Lorem ipsum Lorem ipsum" }
]

export default function Footer() {
    return (
        <div className="flex flex-col">
            <div className="flex flex-row justify-between border-t p-6">
                <div className="flex flex-row gap-24">
                    {columns.map((col, index) => (
                        <div key={index} className="flex flex-col gap-2">
                            ...
                            <div className="text-gray-600">{col.body1}</div>
                            <div className="text-gray-600">{col.body2}</div>
                            <div className="text-gray-600">{col.body3}</div>
                            <div className="text-gray-600">{col.body4}</div>
                        </div>
                    ))}
                </div>
                <div className="flex flex-row gap-x-6">
                    <a href="https://www.linkedin.com/company/symbios-bio-suite/" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://github.com/Symbios-Bio-Suite" target="_blank" rel="noopener noreferrer">
            ...
            <div className="border-t py-4 text-center">
                © 2025 Symbios Bio-Suite. All rights reserved.
            </div>
        </div>
    )
}