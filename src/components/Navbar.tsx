...
export default function NavBar() {
    ...
    return (
        <div className={`w-full flex flex-col justify-center bg-slate-500 text-white fixed px-6 transition-all duration-300 z-50 ${menu ? "bg-opacity-100" : "bg-opacity-80"}  ${scroll ? "h-16" : "h-24"}`}>
            <div className="flex flex-row items-center justify-between">
                ...
                <div className="flex flex-row items-center gap-x-6">
                    <div className="flex flex-row items-center gap-x-2.5">
                        <a href="https://github.com/spencerhum04" target="_blank" rel="noopener noreferrer" className="flex flex-row gap-x-2.5 items-center rounded-sm hover:bg-white hover:bg-opacity-15 focus:bg-opacity-20 p-2.5 hover:underline">
                        ...
                        <a href="https://ca.linkedin.com/in/spencer-hum" target="_blank" rel="noopener noreferrer" className="flex flex-row gap-x-2.5 items-center rounded-sm hover:bg-white hover:bg-opacity-15 focus:bg-opacity-20 p-2.5 hover:underline">
                    ...
                    <button className="hidden sm:block bg-sand hover:bg-white font-medium px-3 py-1.5 rounded-lg text-black">
                        Contact
                    </button>
                ...
                {menu && (
                    <div className={`absolute left-0 w-full bg-black text-white flex flex-col gap-y-4 px-6 pb-6 pt-4 text-xl transition-all duration-300 ${scroll ? "top-16" : "top-24"}`}>
                            <button className="font-medium text-left">Projects</button>
                            <button className="font-medium text-left">Experience</button>
                    </div>
                )}
            </div>
        </div>
